...
const gris = new Game("Gris", "PlayStation 5", "3h 46m", "/images/grisArt.jpg",
...
const PLA = new Game("Pokémon: Legends Arceus", "Nintendo Switch", "64h 52m", "/images/plaEnd.jpg",
...
const rdr2 = new Game("Red Dead Redemption 2", "Xbox One", "190h 40m", "/images/rdr2.jpg",
...
const mhWorld = new Game("Monster Hunter World", "PlayStation 5", "88h 08m", "/images/xenojiiva.jpg",
...
const mhWilds = new Game("Monster Hunter Wilds", "PlayStation 5", "66h 12m", "/images/mhwilds.jpg",
...
const leafgreen = new Game("Pokemon Leaf Green", "Gameboy Advance", "27h 55m", "/images/leafgreen team.png",
...
const dqXI = new Game("DRAGON QUEST XI S: Echoes of an Elusive Age", "PlayStation 5", "57h 43m" , "/images/DQXIS.jpg",
...
const dqXITrueEnd = new Game("DRAGON QUEST XI S: Echoes of an Elusive Age - ACT III", "PlayStation 5", "80h 05m", "/images/yggdragon.jpg",
